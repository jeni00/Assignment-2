...
function setup() {
    ...
    answerInput.position(windowWidth/2, 500);

    submitButton = createButton("Comment");
    submitButton.position(windowWidth/2, 550);
...
function sendTheMessage() {
  if (answerInput.value() != "") {
    ...
    window.location.href = "https://jeni00.github.io/_pageTwo/index.html?answer="+answer; 
  } else {
